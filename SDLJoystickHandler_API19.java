...
class SDLJoystickHandler_API19 extends SDLJoystickHandler_API16 {
    ...
    public int getButtonMask(InputDevice inputDevice) {
        ...
        boolean[] hasKeys = inputDevice.hasKeys(new int[]{96, 97, 99, 100, 4, 82, 110, 108, 106, 107, 102, 103, 19, 20, 21, 22, 109, 23, 104, 105, 98, 101, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203});
        int i = 0;
